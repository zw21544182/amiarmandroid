...
public class CommonUtil {
    public static final int Device_ShadeLight = 0;//遮光
    public static final int Device_Pressed = 1;//压屏
    public static final int Device_MachineHand = 2;//机械手
    ...
    public static final String OUTBOTTLEFULL = "The  output bottle is full auto device";
    ...
    public static final String LOGINREFUSE = "User login permission refuse";
    public static final String ENTERMENUBTNTRAY = "Enter the system management subsystem MenuBtnTray";
